...
(function () {
  ...
  function init() {
    ...
    var ALIASES = [
      ...
      { k: ['what to say', 'paraphras', 'reflect', 'summaris', 'summariz', 'phrases', 'key word', 'feel heard', 'के भन्ने', 'पुनर्कथन', 'प्रतिबिम्ब', 'सारांश'], u: 'skills-listening.html', te: 'Listening back: paraphrase, reflect, summarise, what to say', tn: 'सुनेको फर्काउने: पुनर्कथन, प्रतिबिम्ब, सारांश, के भन्ने' },
      { k: ['brainstorm', 'confront', 'challenge', 'information giving', 'psychoeducation', 'role-play', 'role play', 'मन्थन', 'चुनौती', 'मनोशिक्षा', 'सूचना दिने'], u: 'skills-moving.html', te: 'Moving forward: brainstorming, challenge, information, psychoeducation', tn: 'अगाडि बढाउने: मन्थन, चुनौती, सूचना, मनोशिक्षा' },
