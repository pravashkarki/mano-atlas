...
| 2.1 Completeness | No placeholders, all URLs live, tested on device. | Privacy policy and support pages live on manoatlas.com before submission; provide reviewer notes describing the safety state and crisis card so they are not mistaken for incomplete flows. |
